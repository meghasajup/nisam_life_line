...
export default function ITCompanyMissionPage() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50">
            ...
            <div className="bg-gradient-to-r from-slate-50 to-gray-50 py-20">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        <h2 className="text-4xl font-bold text-gray-900 mb-4">
                            Why Choose <span className="bg-gradient-to-r from-emerald-500 to-gray-500 bg-clip-text text-transparent">Our Solutions?</span>
                        </h2>
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        {[
                            { title: "Agile Development", description: "Fast, iterative development cycles that adapt to your changing needs", icon: TrendingUp },
                            { title: "24/7 Support", description: "Round-the-clock technical support and maintenance services", icon: Shield },
                            { title: "Scalable Solutions", description: "Architecture designed to grow with your business requirements", icon: Target }
                        ].map((item, index) => (
                            <div key={index} className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 hover:border-emerald-200 group">
                                <div className="w-16 h-16 bg-gradient-to-r from-emerald-500 to-gray-500 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">

...
export const TechnologyPage = () => {
  return (
    <div className="max-w-7xl mx-auto bg-gradient-to-r from-gray-500 to-emerald-800 rounded-[30px] p-10 text-white flex flex-col md:flex-row justify-between items-start md:items-center gap-10 md:gap-20 mt-10">
